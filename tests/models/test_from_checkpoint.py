...
class TestFromCheckpointNamespaceArgs:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("rfdetr-lingbot-small.pth", "RFDETRLingBotSmall"),
            ("rfdetr-lingbot-small-seg.pth", "RFDETRLingBotSmallSeg"),
...
class TestFromCheckpointModelName:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("RFDETRLingBotSmall", "RFDETRLingBotSmall"),
            ("RFDETRLingBotSmallSeg", "RFDETRLingBotSmallSeg"),
